...
static const char *volupcmd[]   = { "amixer", "set", "-c0", "Master", "5%+", "unmute", NULL };
static const char *voldowncmd[] = { "amixer", "set", "-c0", "Master", "5%-", "unmute", NULL };
static const char *volmutecmd[] = { "amixer", "set", "-c0", "Master", "toggle", NULL };
static const char *brightcmd[]  = { "xbacklight", "+1", NULL };
static const char *darkcmd[]    = { "xbacklight", "-1", NULL };
...
static Key keys[] = {
	...
	{ 0,                            0x1008ff03, spawn,          {.v = darkcmd } },
	{ 0,                            0x1008ff02, spawn,          {.v = brightcmd } },
